...
public struct Block: Codable {
    ...
    public init(from decoder: Decoder) throws {
        let container: KeyedDecodingContainer<Block.CodingKeys> = try decoder.container(keyedBy: Block.CodingKeys.self)
        self.isDefault = try container.decode(Bool.self, forKey: Block.CodingKeys.isDefault)
        self.isParam = try container.decode(Bool.self, forKey: Block.CodingKeys.isParam)
        self.position = try container.decode(Int.self, forKey: Block.CodingKeys.position)
